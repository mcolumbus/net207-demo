...
gcloud beta compute network-endpoint-groups delete $NEG_NAME --zone asia-southeast1-b
...
gcloud beta compute network-endpoint-groups delete $NEG_NAME --zone us-central1-c